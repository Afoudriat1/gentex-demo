...
CSV_PATH = BENCH_DIR / 'phi_metrics.csv'
JSONL_PATH = BENCH_DIR / 'phi_metrics.jsonl'
MODEL_PATH = Path('/Users/andrewfoudriat/GENTEX DEMO/models/Phi-3.5-mini-instruct-Q4_K_M.gguf')
REPORT_HTML = BENCH_DIR / 'phi_full_report.html'
REPORT_MD = BENCH_DIR / 'phi_full_report.md'
...
def build_markdown(latest, rows):
    ...
    # Rough memory breakdown for 3.8B Q4_K_M (ctx=4096)
    model_buf_mib = 2600.0
    kv_cache_mib = 384.0
    compute_buf_mib = 500.0
    output_buf_mib = 0.8
    token_cache_mib = 1.0
    ...
    return (
        f"# Phi-3.5 Mini (Q4_K_M) – Full Benchmark Report\n\n"
