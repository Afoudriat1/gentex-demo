...
CSV_PATH = BENCH_DIR / 'qwen_metrics.csv'
JSONL_PATH = BENCH_DIR / 'qwen_metrics.jsonl'
MODEL_PATH = Path('/Users/andrewfoudriat/GENTEX DEMO/models/qwen2.5-3b-q4_k_m.gguf')
REPORT_HTML = BENCH_DIR / 'qwen_full_report.html'
REPORT_MD = BENCH_DIR / 'qwen_full_report.md'
...
def build_markdown(latest, rows):
    ...
    # Estimated memory breakdown for Qwen2.5-3B Q4_K_M (ctx=4096)
    model_buf_mib = 2000.0  # ~2.0 GB for Q4_K_M 3B params
    kv_cache_mib = 320.0    # ctx 4096, f16 KV, 32 layers
    compute_buf_mib = 400.0
    output_buf_mib = 0.6
    token_cache_mib = 1.0
    ...
    return (
        f"# Qwen2.5-3B (Q4_K_M) – Full Benchmark Report\n\n"
